 ...
 * @version $Id:$
 */
public final class HornetqCommunicator implements Communicator
{
    ...
    private static final Logger LOG =
        LogFactory.getLogger(HornetqCommunicator.class);
     ...
     */
    @Inject
    public HornetqCommunicator(MessageMarshaller messageMarshaller,
